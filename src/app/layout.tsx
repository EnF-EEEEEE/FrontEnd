  ...
  return (
    <html lang="ko">
      ...
      >
        ...
        <main className="h-full w-full max-w-[476px] flex flex-col shadow-2xl bg-white02">
          {/* <main className="min-h-[100svh] w-full max-w-[476px] flex flex-col shadow-2xl bg-white02"> */}
